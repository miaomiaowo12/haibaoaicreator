  ...
  return (
    <div className="flex items-end gap-2 bg-gray-100 rounded-2xl px-4 py-2">
      ...
      <button
        ...
        disabled={disabled}
        className="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-gray-500 hover:text-purple-600 hover:bg-purple-50 transition-all disabled:opacity-50"
        title="上传背景图"
      >
